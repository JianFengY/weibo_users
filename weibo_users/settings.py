...
# Scrapy settings for weibo_users project
#
...
BOT_NAME = 'weibo_users'

SPIDER_MODULES = ['weibo_users.spiders']
NEWSPIDER_MODULE = 'weibo_users.spiders'
...
# SPIDER_MIDDLEWARES = {
#    'weibo_users.middlewares.WeiboUsersSpiderMiddleware': 543,
# }
